...
import static com.oasis.taskmanagementapp.dto.ErrorCode.CONSTRAINT_VIOLATION;

@ControllerAdvice
public class OasisExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({OasisException.class, TaskServiceException.class, UnAuthorizedException.class})
    public ResponseEntity<Object> handleCustomException(OasisException e) {
